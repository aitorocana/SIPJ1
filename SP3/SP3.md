...
- **Exercici 3:** Ara el que farem es Afegir l’usuari que has creat dintre d’un dels grups del domini amb ldapmodify. Utilitzem un dels arxius creats d'avans, borro lo anterior i fem aixó per a afegir l'usuari creat dintre d'un dels grups.
...
- **Exercici 5:** Ara mourem l'usuari Aitor que he creat a la nova uo. Utilitzem un dels arxius creats d'avans, borro lo anterior i fem aixó per a modificar el dn amb el que volem modificar.
